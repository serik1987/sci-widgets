...
SciDateRange.templateText = `
    <style>
        ...
        :host([in-block]) sci-date{
            display: block;
        }
        
        :host([in-block]) #start-date{
            margin-top: 20px;
        }
        
        :host([in-block]) #finish-date{
            margin-bottom: 20px;
        }
    ...
    <sci-date id="start-date"></sci-date>
    <sci-date id="finish-date"></sci-date>
`;
